...
await fs.promises.writeFile(path.join(import.meta.dirname, 'syntaxes', 'cp.tmLanguage.json'), JSON.stringify({
	...
	repository: {
		...
		GenericParameterPossible:      Pattern.GENERIC_PARAMETER_POSSIBLE,
		...
		ParameterPossible:             Pattern.PARAMETER_POSSIBLE,
		...
		TypeParameterPossible:         Pattern.TYPE_PARAMETER_POSSIBLE,
