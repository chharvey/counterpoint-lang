...
await fs.promises.writeFile(path.join(import.meta.dirname, '../', 'cpl.tmLanguage.json'), JSON.stringify({
	...
	repository: {
		...
		DestructureArgument:           destructure('Argument',         '#IdentifierParameter'),
		DestructureAssignment:         destructure('Assignment',       '#ExpressionAssignee'),
		DestructureGenericArgument:    destructure('GenericArgument',  '#IdentifierParameter'),
		DestructureGenericParameter:   destructure('GenericParameter', '#IdentifierParameter'),
		DestructureParameter:          destructure('Parameter',        '#IdentifierParameter'),
		DestructureProperty:           destructure('Property',         '#IdentifierProperty'),
		DestructureTypeAlias:          destructure('TypeAlias',        '#IdentifierType'),
		DestructureTypeProperty:       destructure('TypeProperty',     '#IdentifierProperty'),
		DestructureVariable:           destructure('Variable',         '#IdentifierVariable'),
