...
function print(message: str): void implements VoidFn.<str> {;}
function print<T>(message: T): void implements VoidFn.<T> {;}
function print<T narrows str>(message) implements VoidFn.<T> {;}
claim print(message: str): void;
claim print(message: str): void implements VoidFn.<str>;
claim print<T>(message: T): void implements VoidFn.<T>;
claim print<T narrows str>(message) implements VoidFn.<T>;
claim print: (message: str) => void;
