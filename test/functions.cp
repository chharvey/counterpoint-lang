...
function add<T>(x: T, y: T): T implements BinaryOperator.<T> {
	return x + y;
}
function add<T>(x, y) implements BinaryOperator.<T> {
	return x + y;
}
function add<T>(x: T, y: T): T implements BinaryOperator.<T> => x + y;
function add<T>(x, y) implements BinaryOperator.<T> => x + y;

function addCaptures<T>[z](x: T, y: T): T implements BinaryOperator.<T> {
	return x + y + z;
}
function addCaptures<T>[z](x, y) implements BinaryOperator.<T> {
	return x + y + z;
}
function addCaptures<T>[z](x: T, y: T): T implements BinaryOperator.<T> => x + y + z;
function addCaptures<T>[z](x, y) implements BinaryOperator.<T> => x + y + z;
