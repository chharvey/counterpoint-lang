type TypeKeywords    = nothing | bool | sym | nat | int | float | str | anything;
type TypeClasses     = Object | Class | List | Dict | Set | Map;
type TypeConstants   = null | false | true;
type TypeNonKeywords = never | boolen | symbol | natural | integer | string | object | class | list | dict | set | map | unknown;
