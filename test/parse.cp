...
let f: obj = (param= [x, y]: int          ?= [1, 2]):         int => x + y;
let f: obj = (param= [_, y]: int          ?= [1, 2]):         int => y;
let f: obj = (param= [x: int, y: int]     ?= [1, 2]):         int => x + y;
let f: obj = (param= [_: int, y: int]     ?= [1, 2]):         int => y;
let f: obj = (until= [if$, by= b]: int    ?= [if= 1, by= 2]): int => if + b;
let f: obj = (_=     [_$,  by= _]: int    ?= [_=  1, by= 2]): int => _;
let f: obj = (_=     [_$,  _=  b]: int    ?= [_=  1, _=  2]): int => _;
let f: obj = (param= [x$: int, y= b: int] ?= [x=  1, y=  2]): int => x + b;
let f: obj = (param= [[unfixed x], [y= [b]]]: int ?= [[1], [y= [2]]]): int => x + b;
let f: obj = (param= [x, y]: int                  ?= [1, 2]):          int { return x + y; };
let f: obj = (param= [x: int, y: int]             ?= [1, 2]):          int { return x + y; };
let f: obj = (until= [if$, by= b]: int            ?= [if= 1, by= 2]):  int { return if + b; };
let f: obj = (param= [x$: int, y= b: int]         ?= [x= 1, y= 2]):    int { return x + b; };
let f: obj = (param= [[unfixed x], [y= [b]]]: int ?= [[1], [y= [2]]]): int { return x + b; };
